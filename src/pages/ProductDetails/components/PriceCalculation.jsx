...
//   startDate, 
//   endDate, 
//   selectedOptions // Options sélectionnées (avec prix supplémentaire)
// }) {
...
//   // Prix de location pour les 1 à 4 premiers jours
//   const basePriceForFirstFourDays = dailyUnitPrice * Math.min(days, 4) * quantity;

//   // Prix de location pour les jours supplémentaires (à partir du 5ème jour)
//   let extraPrice = 0;
//   if (days > 4) {
//     const extraDays = days - 4;
//     for (let i = 1; i <= extraDays; i++) {
//       extraPrice += dailyUnitPrice * (1 + i * 0.15) * quantity;
//     }
//   }

//   // Total final
//   const totalPrice = basePriceForFirstFourDays + extraPrice;
...
//         <Typography>{formatPrice(dailyUnitPrice)}</Typography>
//       </Box>
